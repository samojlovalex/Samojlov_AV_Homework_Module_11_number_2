...
import com.example.samojlov_av_homework_module_11_number_2.databinding.ActivityMainBinding

class MainActivity : AppCompatActivity() {

    private lateinit var binding: ActivityMainBinding
    private lateinit var toolbarMain: androidx.appcompat.widget.Toolbar
    private lateinit var enterLaunchBTN: Button
...
//        setContentView(R.layout.activity_main)
    ...
    private fun init() {
        ...
        enterLaunchBTN = binding.enterLaunchBTN
        enterLaunchBTN.setOnClickListener {
